...
(function ($) {
     ...
     */
    const SaaSPrimeSideHeader = function ($scope, $) {
        let menu_open = $('.menu--open', $scope);
        let menu_close = $('.menu--close', $scope);
        let side_header = $('.saasprime--side-header', $scope);
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/saasprime--side-header.default', SaaSPrimeSideHeader);
    });
})(jQuery);