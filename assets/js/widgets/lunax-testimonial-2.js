...
(function ($) {
     ...
     */
    const SaaSPrimeTestimonial2 = function ($scope, $) {
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/saasprime--testimonial-2.default', SaaSPrimeTestimonial2);
    });
})(jQuery);
