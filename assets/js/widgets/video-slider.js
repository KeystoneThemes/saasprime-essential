...
(function ($) {
     ...
     */
    const SaaSPrimeVideoSlider = function ($scope, $) {
        const slider = $($('.saasprime_video_slider', $scope)[0]);
        const sliderSettings = $($('.saasprime_vs_wrapper', $scope)[0]).data('settings') || {};
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/saasprime--video-slider.default', SaaSPrimeVideoSlider);
    });
})(jQuery);
