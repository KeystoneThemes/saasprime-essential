(function ($) {
     ...
     */
    var SaaSPrimeProgressBar = function ($scope, $) {
        let wrapper = $scope.find('.saasprime_progressbar');
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/saasprime--progressbar.default', SaaSPrimeProgressBar);
    });
})(jQuery);