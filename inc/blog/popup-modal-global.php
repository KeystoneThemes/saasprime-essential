...
<?php
$json_data = saasprime_get_config_value_by_name( 'elementor/layouts' );
?>
<script>
...
<div class="wdb-modal wdb--remote-layouts">
    ...
    <div class="wdb-modal__inner">
        ...
        <img src="<?php echo SAASPRIME_ESSENTIAL_ASSETS_URL . 'images/logo-icon.svg'; ?>" />
        <h2 class="wdb-tpl-layout-header"><?php echo esc_html__( 'Template Layout Import', 'saasprime-essential' ) ?></h2>
        ...
        <div class="wdb-content-install">
            <div class="wdb-single-tpl-wrapper">
                <h4><?php //echo esc_html__('Elementor Layout','saasprime-essential') ?></h4>
                <h1></h1>
                <div class="data-details"></div>
                <div class="wdb--blog-builder-templates"></div>
                <div hidden class="wdb-pagi-wrapper"><h3><?php echo esc_html__( 'Page:', 'saasprime-essential' ); ?></h3>
