<?php 
  ...
  $json_data = saasprime_get_config_value_by_name('elementor/archive');
  $args = array(
    'numberposts' => 15,
...
<div class="wdb-modal wdb--remote-layouts">
  ...
  <div class="wdb-modal__inner">
    ...
    <h2><?php echo esc_html__('Blog Template Layout Import','saasprime-essential') ?></h2>
            ...
            <?php foreach($json_data as $item){ ?> 
                <div class="wdb-image-tpl <?php //echo $active_id == $item->ID ? 'active' : ''; ?>">
                    ...
                    <div class="wdb-hover-element">
                        <span data-id="<?php echo $item['uniq_id']; ?>" class="wdb--blog-tpl-install-remote"><?php echo esc_html__('Activate','saasprime-essential'); ?></span>
                    </div>
                </div>
                <?php } ?>
