...
<div class="wdb-error-tpl-wrapper">
    <h4><a class="wdb-post-layout-import-modal button button-primary csf--button" data-id="error_layout" href="javascript:void(0)"><?php echo esc_html__('Import From Library','saasprime-essential') ?></a> </h4>
