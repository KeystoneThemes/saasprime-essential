    ...
    function sticky_transparent_option($element){    
            ...
            $element->start_controls_section(
                ...
                [
                    ...
                    'label' => esc_html__( 'WDB Sticky', 'saasprime-essential' ),
                ]
            );
                ...
                $element->add_control(
                    'wdb_global_sticky',
                    [
                        'label' => esc_html__( 'Sticky', 'saasprime-essential' ),
                ...
                $element->add_responsive_control(
                    'wdb_sticky_type',
                    [
                        'label' => esc_html__( 'Sticky Type', 'saasprime-essential' ),
                        'type' => \Elementor\Controls_Manager::SELECT,
                        'default' => '',                       
                        'options' => [

                            'top'    => esc_html__('Top','saasprime-essential'),
                ...
                $element->add_control(
                    'wdb_sticky_offset',
                    [
                        'label' => esc_html__( 'Sticky Offset', 'saasprime-essential' ),
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__( 'Z-index', 'saasprime-essential' ),
                        'type' => \Elementor\Controls_Manager::NUMBER,
                        'min' => -2000,
                        'max' => 99999,
                        'step' => 5,
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__( 'Header Navigation', 'saasprime-essential' ),
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__( 'Menu Color', 'saasprime-essential' ),
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__( 'Menu Hover Color', 'saasprime-essential' ),
                        'type' => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [                           
                ...
                $element->add_control(
                    ...
                    [
                        'label' => esc_html__( 'Svg Icon Color', 'saasprime-essential' ),
                        'type' => \Elementor\Controls_Manager::COLOR,
                        'selectors' => [
                ...
                $element->add_group_control(
                    ...
                    [
                        ...
                        'label' => esc_html__( 'Menu Typography', 'saasprime-essential' ),
