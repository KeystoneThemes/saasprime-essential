...
function saasprime_register_site_dynamic_tag_group( $dynamic_tags_manager ) {

	$dynamic_tags_manager->register_group(
		'wdb',
		[
			'title' => esc_html__( 'WDB', 'saasprime-essential' )
		]
	);

}
add_action( 'elementor/dynamic_tags/register', 'saasprime_register_site_dynamic_tag_group' );
