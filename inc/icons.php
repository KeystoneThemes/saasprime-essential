...
Class SaaSPrime_Additional_Icon{
    ...
    public function theme_custom_icon_manager($settings){
        ...
        $json_data = SAASPRIME_ESSENTIAL_URL . 'assets/js/elementor-icon.js';

        $settings['saasprime-icon-set'] = [
           'name'          => 'wdb-icon-set',
           'label'         => esc_html__( 'SaaSPrime Icons', 'saasprime-essential' ),
           'url'           => SAASPRIME_CSS . '/custom-icons.css',
           'enqueue'       => [ SAASPRIME_CSS . '/custom-icons.css' ],
           'prefix'        => 'saasprime-',
           'displayPrefix' => 'saasprime-theme',
