...
class wdb_Header_Mega_Menu extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Disable Megamenu in Mobile', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'saasprime-essential' ),
				'label_off' => esc_html__( 'No', 'saasprime-essential' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'offcanvas_align',
			[
				'label'   => esc_html__('Animated Direction', 'saasprime-essential'),
				'type'    => Controls_Manager::CHOOSE,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Mega Menu', 'saasprime-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Container layout', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					...
					'position: fixed;
						width: 100%;					  
						left: 0;' => esc_html__( 'Full Width', 'saasprime-essential' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Position Top', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%'],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Position Left', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%'],
				'range' => [
					'px' => [
