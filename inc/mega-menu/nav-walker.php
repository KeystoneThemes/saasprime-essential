    ...
    **/
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        */
        ...
        if ( $this->elementor_settings['has_dropdown_arrow_icon'] && $depth === 0 && in_array('menu-item-has-children', $classes) || ($depth === 0 && $is_megamenu_item)) {
            $item_output .= saasprime_render_elementor_icons( $this->elementor_settings['menu_down_icon'] );
        }
        
        if ( $this->elementor_settings['has_right_arrow_icon'] && $depth > 0 && in_array('menu-item-has-children', $classes)) {
            $item_output .= saasprime_render_elementor_icons( $this->elementor_settings['menu_right_icon'] );
        }
                ...
                if ($item_meta['is_mega_menu'] == 'on' && class_exists('Elementor\Plugin')) {   
                    ...
                    if ($item_meta['content_id'] != '' && $elementor_page) {
                        ...
                        if( current_user_can('editor') || current_user_can('administrator') ) {    
                            ...
                            esc_html__('No content found', 'saasprime-essential'),
                            $elementor_link,
                            esc_html__('Edit Content', 'saasprime-essential'),
                            );
                            $output .= $no_content;
                        }
                    }
	...
	public static function fallback( $args ) {
		...
		if ( current_user_can( 'manage_options' ) ) {
			...
			echo saasprime_return( $fb_output );
		}
	}
