...
Class Wdb_Mega_Menu_Cpt{
    ...
    function custom_post_type(){
        ...
        register_post_type('wdb-mega-menu-tpl',
            array(
                'labels'      => array(
                    'name'          => __('Mega Menu', 'SAASPRIME_ESSENTIAL'),
                    'singular_name' => __('Mega Menu', 'SAASPRIME_ESSENTIAL'),
                ),
                'public'              => true,
    ...
    public function register_sub_menu_post() {       
        add_submenu_page( 'wdb-saasprime-theme-parent' , esc_html__( 'Mega Menu','saasprime-essential' ) , esc_html__( 'Mega Menu','saasprime-essential' ) , 'manage_options' , 'edit.php?post_type='.$this->type);      
    }
    ...
    public function add_buttons_html($post_id){
        ...
        $elementor_link,
        esc_html__('Edit With Elementor','saasprime-essential'),
        $post_id,
        esc_html__('Add To Menu','saasprime-essential'),
        // $post_id,
        // esc_html__('Edit Here','saasprime-essential')
        );       
