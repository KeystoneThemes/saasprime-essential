 ...
 * @since 1.0.0
 */
class SaaSPrime_Case_Study_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'SaaSPrime Case Study', 'saasprime-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'saasprime-case-study', SAASPRIME_ESSENTIAL_ASSETS_URL . 'css/saasprime-case-study-slider.css' );
		return [ 'saasprime-case-study' ];
	}

	public function get_script_depends() {
		wp_register_script( 'saasprime-case-study', SAASPRIME_ESSENTIAL_ASSETS_URL . '/js/widgets/saasprime-case-study-slider.js', [ 'jquery' ], false, true );

		return [ 'swiper', 'saasprime-case-study' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Case Study', 'saasprime-essential' ),
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Subtitle', 'saasprime-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	private function slider_navigation_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'options'   => [
					'start'         => [
						'title' => esc_html__( 'Start', 'saasprime-essential' ),
					...
					'end'           => [
						'title' => esc_html__( 'End', 'saasprime-essential' ),
						'icon'  => "eicon-align-end-h",
					],
					'space-between' => [
						'title' => esc_html__( 'Space Between', 'saasprime-essential' ),
		...
		$this->add_responsive_control(
			'arrows_margin',
			[
				'label'      => esc_html__( 'Wrapper Margin', 'saasprime-essential' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'wrapper',
			[
				'class'         => [ 'saasprime-case-study-slider' ],
