...
class Lottie extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
			'source',
			[
				'label' => esc_html__( 'Source', 'saasprime-essential' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'media_file',
				'options' => [
					'media_file' => esc_html__( 'Media File', 'saasprime-essential' ),
					'external_url' => esc_html__( 'External URL', 'saasprime-essential' ),
				],
		...
		$this->add_control(
			'source_external_url',
			[
				'label' => esc_html__( 'External URL', 'saasprime-essential' ),
				...
				'placeholder' => esc_html__( 'Enter your URL', 'saasprime-essential' ),				
			]
		);
		...
		$this->add_control(
			'source_json',
			[
				'label' => esc_html__( 'Upload JSON File', 'saasprime-essential' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Trigger', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',		
				'options' => [
					'' => esc_html__( 'None', 'saasprime-essential' ),
					'scroll' => esc_html__( 'On Scroll', 'saasprime-essential' ),
					'hover' => esc_html__( 'On Hover', 'saasprime-essential' ),
					'cursor_move'  => esc_html__( 'Mouse Cursor', 'saasprime-essential' ),					
					'click'  => esc_html__( 'On Click', 'saasprime-essential' ),					
					'viewport'  => esc_html__( 'Viewport', 'saasprime-essential' ),					
				],				
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Pause', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',	
				'condition' => ['wdb_interactivity_event' => ['click','hover','viewport']],
				'options' => [
					'' => esc_html__( 'None', 'saasprime-essential' ),
					'onmouseleave' => esc_html__( 'On Mouseleave', 'saasprime-essential' ),
					'onclick' => esc_html__( 'On Click', 'saasprime-essential' ),						
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Replay', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'condition' => ['wdb_interactivity_event' => ['click','hover','viewport'], 'wdb_interactivity_event_pause!' => ['']],
				'default' => '',				
				'options' => [
					'' => esc_html__( 'None', 'saasprime-essential' ),
					'onhover' => esc_html__( 'On Hover', 'saasprime-essential' ),
					'onclick' => esc_html__( 'On Click', 'saasprime-essential' ),
					'inview'  => esc_html__( 'Viewport', 'saasprime-essential' )		
				],				
			]
		);
		...
		$this->add_control(
			'start_point',
			[
				'label' => esc_html__( 'Start Point', 'saasprime-essential' ),
		...
		$this->add_control(
			'end_point',
			[
				'label' => esc_html__( 'End Point', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'condition' => ['wdb_interactivity_event' => ['scroll','cursor_move']],
				'size_units' => [ 'px' ],
				'range' => [
		...
		$this->add_control(
			'controls',
			[
				'label' => esc_html__( 'Controls?', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'saasprime-essential' ),
				'label_off' => esc_html__( 'No', 'saasprime-essential' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'loop_count',
			[
				'label' => esc_html__( 'Times', 'saasprime-essential' ),
		...
		$this->add_control(
			'backward',
			[
				'label' => esc_html__( 'Backward Direction?', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'saasprime-essential' ),
				'label_off' => esc_html__( 'No', 'saasprime-essential' ),
				'condition' => ['wdb_interactivity_event' => ['hover']],
				'return_value' => 'yes',
				'description' => esc_html__('Play it backward.','saasprime-essential'),
				'default' => '',
			]
		);		
		...
		$this->add_control(
			'wdb_speed',
			[
				'label' => esc_html__( 'Speed', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Additiuonal Properties', 'saasprime-essential' ),
		...
		$this->add_control(
			'wdb_renderer',
			[
				'label' => esc_html__( 'Renderer', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => esc_html__( 'Default', 'saasprime-essential' ),
					'svg' => esc_html__( 'Svg', 'saasprime-essential' ),
					// 'html' => esc_html__( 'Html', 'saasprime-essential' ),
					'canvas'  => esc_html__( 'Canvas', 'saasprime-essential' ),					
				],				
			]
		);		
		...
		$this->add_control(
			'intermission',
			[
				'label' => esc_html__( 'Intermission', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'condition' => ['wdb_interactivity_event' => ['']],
				'description' => esc_html__('Duration (in milliseconds) to pause before playing each cycle in a looped animation. Set this parameter to 0 (no pause) or any positive number. ','saasprime-essential'),
				'range' => [
					'px' => [
						'min' => 0,
						'max' => 500,
