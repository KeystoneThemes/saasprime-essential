...
class SaaSPrime_Gallery extends Widget_Base {

	public function get_name() {
		return 'saasprime--gallery';
	}

	public function get_title() {
		return esc_html__( 'SaaSPrime Gallery', 'saasprime-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'saasprime-gallery', SAASPRIME_ESSENTIAL_ASSETS_URL . 'css/saasprime-gallery.css' );

		return [ 'saasprime-gallery' ];
	}

	public function get_script_depends() {
		wp_register_script( 'saasprime-gallery', SAASPRIME_ESSENTIAL_ASSETS_URL . '/js/widgets/saasprime-gallery.js', [ 'jquery' ], false, true );
	...
	protected function register_controls() {
		$this->start_controls_section(
			'sec_gallery',
			[
				'label' => __( 'Gallery', 'saasprime-essential' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Case Study', 'saasprime-essential' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$this->add_control(
			'g_title_tag',
			[
				'label'   => esc_html__( 'HTML Tag', 'saasprime-essential' ),
	...
	protected function gallery_slider_one_controls() {
		$this->start_controls_section(
			'sec_g_slider',
			[
				'label' => __( 'Gallery Slider One', 'saasprime-essential' ),
			]
		);
		...
		$g_slider->add_control(
			'gs_source',
			[
				'label'   => esc_html__( 'Type', 'saasprime-essential' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'image',
				'options' => [
					'image' => esc_html__( 'Image', 'saasprime-essential' ),
					'video' => esc_html__( 'Video', 'saasprime-essential' ),
				],
			]
		);
		...
		$g_slider->add_control(
			...
			[
				'label'       => esc_html__( 'Title', 'saasprime-essential' ),
				'type'        => Controls_Manager::TEXT,
				'default' => __( 'Mastartery', 'saasprime-essential' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$g_slider->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default' => __( 'Design - 2019', 'saasprime-essential' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$this->add_control(
			'gs_items',
			[
				'label'       => esc_html__( 'Gallery Slider Items', 'saasprime-essential' ),
		...
		$this->add_control(
			'gs_title_tag',
			[
				'label'   => esc_html__( 'Title HTML Tag', 'saasprime-essential' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'h1'   => 'H1',
					'h2'   => 'H2',
	...
	protected function gallery_slider_two_controls() {
		$this->start_controls_section(
			'sec_g_slider_2',
			[
				'label' => __( 'Gallery Slider Two', 'saasprime-essential' ),
			]
		);
	...
	public function register_style_controls() {
		...
		$this->start_controls_section(
			'sec_style_item',
			[
				'label' => esc_html__( 'Gallery', 'saasprime-essential' ),
		...
		$this->add_responsive_control(
			'img_vdo_height',
			[
				'label' => esc_html__( 'Image/Video Height', 'saasprime-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'separator' => 'before',
				'range' => [
		...
		$this->start_controls_section(
			'sec_style_circle',
			[
				'label' => esc_html__( 'Circle', 'saasprime-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'progress_size',
			[
				'label' => esc_html__( 'Progress Size', 'saasprime-essential' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
