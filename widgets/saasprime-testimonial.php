 ...
 * @since 1.0.0
 */
class SaaSPrime_Testimonial extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'SaaSPrime Testimonial', 'saasprime-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'saasprime-testimonial', SAASPRIME_ESSENTIAL_ASSETS_URL . 'css/saasprime-testimonial.css' );
		return [ 'saasprime-testimonial' ];
	}

	public function get_script_depends() {
		wp_register_script( 'saasprime-testimonial', SAASPRIME_ESSENTIAL_ASSETS_URL . '/js/widgets/saasprime-testimonial.js', [ 'jquery' ], false, true );

		return [ 'swiper', 'saasprime-testimonial' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Testimonial', 'saasprime-essential' ),
			]
		);
		...
		$this->add_control(
			'element_list',
			[
				'label'   => esc_html__( 'Testimonial Style', 'saasprime-essential' ),
		...
		$repeater->add_control(
			'top_text',
			[
				'label' => esc_html__( 'Top Text', 'saasprime-essential' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Default Text ', 'saasprime-essential' ),
			]
		);
		...
		$repeater->add_control(
			'testimonial_content',
			[
				'label'   => esc_html__( 'Feedback', 'saasprime-essential' ),
		...
		$repeater->add_control(
			'testimonial_image',
			[
				'label'   => esc_html__( 'Client Image', 'saasprime-essential' ),
		...
		$repeater->add_control(
			'testimonial_quote',
			[
				'label'   => esc_html__( 'Choose Quote', 'saasprime-essential' ),
				'type'    => Controls_Manager::MEDIA,
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_control(
			'testimonial_logo',
			[
				'label'   => esc_html__( 'Logo/Rating Image', 'saasprime-essential' ),
				'type'    => Controls_Manager::MEDIA,
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_control(
			'testimonial_job',
			[
				'label'       => esc_html__( 'Designation', 'saasprime-essential' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
		...
		$this->add_control(
			'testimonials',
			[
				'label'   => esc_html__( 'Testimonials', 'saasprime-essential' ),
		...
		$this->start_controls_section(
			'section_slide_style',
			[
				'label' => esc_html__( 'Slide', 'saasprime-essential' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .saasprime__testimonial-1 .slide::after, {{WRAPPER}} .saasprime__testimonial-2 .slide::after'  => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			'top_c_padding',
			[
				'label'      => esc_html__( 'Content Padding', 'saasprime-essential' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'separator' => 'before',
				'selectors'  => [
		...
		$this->add_responsive_control(
			'client_padding',
			[
				'label'      => esc_html__( 'Client Padding', 'saasprime-essential' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			'top_text_show',
			[
				'label'     => esc_html__( 'Top Text Show', 'saasprime-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'none',
				'options'   => [
					'none'  => esc_html__( 'Hide', 'saasprime-essential' ),
					'block' => esc_html__( 'Show', 'saasprime-essential' ),
				],
				'selectors' => [
		...
		$this->add_responsive_control(
			'img_show',
			[
				'label'     => esc_html__( 'Image Show', 'saasprime-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'block',
				'options'   => [
					'none'  => esc_html__( 'Hide', 'saasprime-essential' ),
		...
		$this->start_controls_section(
			'sec_style_tm_quote',
			[
				'label' => esc_html__( 'Quote', 'saasprime-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'quote_show',
			[
				'label'     => esc_html__( 'Quote Show', 'saasprime-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'block',
				'options'   => [
					'none'  => esc_html__( 'Hide', 'saasprime-essential' ),
		...
		$this->start_controls_section(
			'sec_style_tm_logo',
			[
				'label' => esc_html__( 'Logo/Rating', 'saasprime-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
					'element_list' => ['3', '4'],
				],
	...
	private function slider_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Slider Options', 'saasprime-essential' ),
			]
		);
		...
		$this->add_responsive_control(
			'slides_to_show',
			[
				'label'       => esc_html__( 'Slides to Show', 'saasprime-essential' ),
				'type'        => Controls_Manager::SELECT,
				'default'     => 'auto',
				'required'    => true,
				'options'     => [
		...
		$this->add_control(
			'autoplay',
			[
				'label'   => esc_html__( 'Autoplay', 'saasprime-essential' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'yes',
				'options' => [
					'yes' => esc_html__( 'Yes', 'saasprime-essential' ),
					'no'  => esc_html__( 'No', 'saasprime-essential' ),
				],
			]
		);
		...
		$this->add_control(
			'autoplay_delay',
			[
				'label'     => esc_html__( 'Autoplay delay', 'saasprime-essential' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Autoplay Interaction', 'saasprime-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'true',
				'options'   => [
					'true'  => esc_html__( 'Yes', 'saasprime-essential' ),
					'false' => esc_html__( 'No', 'saasprime-essential' ),
				],
				'condition' => [
					'autoplay' => 'yes',
				],
		...
		$this->add_control(
			'allow_touch_move',
			[
				'label'     => esc_html__( 'Allow Touch Move', 'saasprime-essential' ),
				'type'      => Controls_Manager::SELECT,
				'separator' => 'before',
				'default'   => 'false',
				'options'   => [
		...
		$this->add_control(
			'loop',
			[
				'label'   => esc_html__( 'Loop', 'saasprime-essential' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'true',
				'options' => [
					'true'  => esc_html__( 'Yes', 'saasprime-essential' ),
		...
		$this->add_control(
			'slide_effect',
			[
				'label'   => esc_html__( 'Effect', 'saasprime-essential' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'slide',
				'options' => [
					'slide'     => esc_html__( 'Slide', 'saasprime-essential' ),
					'cards'     => esc_html__( 'Cards', 'saasprime-essential' ),
					'flip'      => esc_html__( 'Flip', 'saasprime-essential' ),
					'fade'      => esc_html__( 'Fade', 'saasprime-essential' ),
					'cube'      => esc_html__( 'Cube', 'saasprime-essential' ),
					'coverflow' => esc_html__( 'CoderFlow', 'saasprime-essential' ),
					'creative'  => esc_html__( 'Creative', 'saasprime-essential' ),
				],
			]
		);
		...
		$this->add_control(
			'speed',
			[
				'label'   => esc_html__( 'Animation Speed', 'saasprime-essential' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 500,
			]
		);
		...
		$this->add_control(
			'navigation',
			[
				'label'     => esc_html__( 'Navigation', 'saasprime-essential' ),
				'type'      => Controls_Manager::SELECT,
				'separator' => 'before',
				'default'   => 'both',
				'options'   => [
					'both'   => esc_html__( 'Arrows and Dots', 'saasprime-essential' ),
					'arrows' => esc_html__( 'Arrows', 'saasprime-essential' ),
					'dots'   => esc_html__( 'Dots', 'saasprime-essential' ),
	...
	private function slider_navigation_style_controls() {
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Arrows', 'saasprime-essential' ),
		...
		$this->add_responsive_control(
			'arrows_type',
			[
				'label' => esc_html__( 'Arrows Position Type', 'saasprime-essential' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'static',
				'options' => [
					'static' => esc_html__( 'Default', 'saasprime-essential' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__( 'Arrow Prev', 'saasprime-essential' ),
				'label_off' => esc_html__( 'Default', 'saasprime-essential' ),
				'label_on' => esc_html__( 'Custom', 'saasprime-essential' ),
				'return_value' => 'yes',
				'condition' => [
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::POPOVER_TOGGLE,
				'label' => esc_html__( 'Arrow Next', 'saasprime-essential' ),
				'label_off' => esc_html__( 'Default', 'saasprime-essential' ),
				'label_on' => esc_html__( 'Custom', 'saasprime-essential' ),
				'return_value' => 'yes',
				'condition' => [
		...
		$this->add_control(
			'dots_color',
			[
				'label'     => esc_html__( 'Active Color', 'saasprime-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'dots_active_size',
			[
				'label'     => esc_html__( 'Active Size', 'saasprime-essential' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 5,
		...
		$this->add_responsive_control(
			'dots_left',
			[
				'label'      => esc_html__( 'Spacing Left', 'saasprime-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			'dots_bottom',
			[
				'label'      => esc_html__( 'Spacing Bottom', 'saasprime-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				'range'      => [
					'px' => [
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'wrapper',
			[
				'class'         => [ 'saasprime_testimonial_wrapper saasprime__testimonial-' . $settings['element_list'] ],
		...
		$this->add_render_attribute(
			'carousel-wrapper',
			[
				'class' => 'saasprime_testimonial_slider ' . $swiper_class,
