...
class Dropdown extends \Elementor\Widget_Base {
    ...
    public function get_style_depends() {
        wp_register_style( 'wdb-thm-dropdown', SAASPRIME_ESSENTIAL_ASSETS_URL . 'css/dropdown.css' );
	...
	public function register_content_controls(){
		...
		$repeater->add_control(
			'list_url',
			[
				'label' => esc_html__( 'Url', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => '#',
				'label_block' => true,
			]
		...
		$this->add_control(
			'polylang_switcher',
			[
				'label' => esc_html__( 'PolyLang Swicher?', 'saasprime-essential' ),
		...
		$this->add_control(
			'list',
			[
				'label' => esc_html__( 'Dropdown Options', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'list_title' => esc_html__( 'Title #1', 'saasprime-essential' ),						
					],					
				],
	...
	public function register_style_controls(){
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Select', 'saasprime-essential' ),
          ...
          <div class="athletic__header-lang">   
              <?php if($settings['polylang_switcher'] == 'yes' && defined( 'POLYLANG_VERSION' )){                
                echo $langs;
                    ...
                    <select id="lang" aria-label="<?php echo esc_attr__('Select Language', 'saasprime-essential'); ?>">
