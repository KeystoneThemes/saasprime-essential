...
class Offcanvas_Menu extends Widget_Base {
	...
	public function get_style_depends() {
		return [ 'saasprime-header-offcanvas' ];
	}
	...
	public function logo_image_url( $size ) {
		...
		if ( ! empty( $settings['custom_image']['url'] ) ) {
			...
			$light_logo = SAASPRIME_IMG . '/lawyer-black-logo.png';
			$logo       = saasprime_option( 'offcanvas_logo', $light_logo );
	...
	public function get_all_images_urls() {
		$returns_data = [];
		$media_dir    = SAASPRIME_ESSENTIAL_DIR_PATH . 'assets/images/bars/';
		$url_path     = SAASPRIME_ESSENTIAL_ASSETS_URL . 'images/bars/';
		try {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'menu_button_text',
			[
				'label'       => esc_html__( 'Button Text', 'saasprime-essential' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => '',
				'placeholder' => esc_html__( 'Menu', 'saasprime-essential' ),
		...
		$this->add_control(
			'custom_bar',
			[
				'label'   => __( 'Custom Bar', 'saasprime-essential' ),
		...
		$this->add_control(
			'bar',
			[
				'label'     => esc_html__( 'Bar', 'saasprime-essential' ),
		...
		$this->add_control(
			'sticky_bar',
			[
				'label'   => __( 'Sticky Bar', 'saasprime-essential' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'preset'              => esc_html__( 'Preset', 'saasprime-essential' ),
					'elementor_shortcode' => esc_html__( 'Custom Shortcode', 'saasprime-essential' ),
		...
		$this->add_control(
			'preset_style',
			[
				'label'     => esc_html__( 'Preset Style', 'saasprime-essential' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => 'two',
				'options'   => [
					'two' => esc_html__( 'One', 'saasprime-essential' ),
//						'three'     => esc_html__( 'Two' , 'saasprime-essential' ),
//						'four'      => esc_html__( 'Three' , 'saasprime-essential' ),
//						'five'      => esc_html__( 'Four' , 'saasprime-essential' ),
//						'six'       => esc_html__( 'Five' , 'saasprime-essential' ),
		...
		$this->add_control(
			'shortcode',
			[
				'label'       => esc_html__( 'Elementor Template ShortCode', 'saasprime-essential' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => '',
				'placeholder' => esc_html__( '[WDB_ELEMENTOR_TPL id="1951"]', 'saasprime-essential' ),
		...
		$this->add_control(
			'show_logo',
			[
				'label'        => esc_html__( 'Show Logo / Custom Image', 'saasprime-essential' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'saasprime-essential' ),
				'label_off'    => esc_html__( 'Hide', 'saasprime-essential' ),
				'return_value' => 'yes',
				'default'      => 'yes',
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => esc_html__( 'List Title', 'saasprime-essential' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Email', 'saasprime-essential' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					...
					'email'   => esc_html__( 'Email', 'saasprime-essential' ),
					'phone'   => esc_html__( 'Phone', 'saasprime-essential' ),
					'address' => esc_html__( 'Address', 'saasprime-essential' ),
				],
			]
		);
		...
		$repeater->add_control(
			'link',
			[
				'label'       => esc_html__( 'Link Value', 'saasprime-essential' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => '#',
				'label_block' => true,
		...
		$this->add_control(
			'contact_info',
			[
				'label'       => esc_html__( 'Contact Info', 'saasprime-essential' ),
		...
		$this->add_control(
			'language_info',
			[
				'label'       => esc_html__( 'Language Info', 'saasprime-essential' ),
				'type'        => \Elementor\Controls_Manager::REPEATER,
		...
		$this->add_control(
			'copyright_texts',
			[
				'label'       => esc_html__( 'Copyright', 'saasprime-essential' ),
		...
		$this->start_controls_section(
			'section_close_area',
			[
				'label' => esc_html__( 'Close Button', 'saasprime-essential' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => __( 'Default?', 'saasprime-essential' ),
				'type'    => Controls_Manager::SWITCHER,
				'yes'     => __( 'Yes', 'saasprime-essential' ),
				'no'      => __( 'No', 'saasprime-essential' ),
				'default' => 'yes',
		...
		$this->add_control(
			'close_text',
			[
				'label'       => esc_html__( 'Close Text', 'saasprime-essential' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => 'close',
				'placeholder' => esc_html__( 'close text', 'saasprime-essential' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'options'   => [
					''                                                         => esc_html__( 'Default', 'saasprime-essential' ),
					'position: absolute;right: 50px;top: 50px; z-index: 1;'    => esc_html__( 'Right Top', 'saasprime-essential' ),
					'position: absolute;left: 50px;top: 50px; z-index: 1;'     => esc_html__( 'Left Top', 'saasprime-essential' ),
					'position: absolute;left: 50px;bottom: 50px; z-index: 1;'  => esc_html__( 'Left Bottom', 'saasprime-essential' ),
					'position: absolute;right: 50px;bottom: 50px; z-index: 1;' => esc_html__( 'Right Bottom', 'saasprime-essential' ),
				],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Main Container', 'saasprime-essential' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Open Text Button', 'saasprime-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Text Shadow', 'saasprime-essential' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Close Icon Button', 'saasprime-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Icon Background', 'saasprime-essential' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Icon Wrapper Width', 'saasprime-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Icon Wrapper Height', 'saasprime-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', '%' ],
				'range'      => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Close Text Button', 'saasprime-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'menu_hht_auto',
			[
				'label'     => esc_html__( 'Height Auto', 'saasprime-essential' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''     => esc_html__( 'No', 'saasprime-essential' ),
					'auto' => esc_html__( 'Yes', 'saasprime-essential' ),
		...
		$this->add_responsive_control(
			'off_menu_dp_padding',
			[
				'label'      => esc_html__( 'Level Two Padding', 'saasprime-essential' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'selectors'  => [
		...
		$this->add_control(
			'menu_icon_heading',
			[
				'label' => esc_html__( 'Menu Icon', 'saasprime-essential' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Contact', 'saasprime-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'contact_display',
			[
				'label'     => esc_html__( 'Display', 'saasprime-essential' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''     => esc_html__( 'Default', 'saasprime-essential' ),
					'none' => esc_html__( 'None', 'saasprime-essential' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Heading Color', 'saasprime-essential' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Body Color', 'saasprime-essential' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Copyright , Search , Lang', 'saasprime-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'footer_c_display',
			[
				'label'     => esc_html__( 'Copyright Display', 'saasprime-essential' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''     => esc_html__( 'Default', 'saasprime-essential' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Copyright Color', 'saasprime-essential' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Copyright Link Color', 'saasprime-essential' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'footer_s_display',
			[
				'label'     => esc_html__( 'Search Display', 'saasprime-essential' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''     => esc_html__( 'Default', 'saasprime-essential' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Search Input Color', 'saasprime-essential' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'footer_l_display',
			[
				'label'     => esc_html__( 'Lang Display', 'saasprime-essential' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''     => esc_html__( 'Default', 'saasprime-essential' ),
		...
		$this->add_control(
			'nav_off_lang_color',
			[
				'label'     => esc_html__( 'Language Color', 'saasprime-essential' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Offcanvas Right', 'saasprime-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Offcanvas Left', 'saasprime-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		if ( $settings['bar'] != '' ) {
			$bar = SAASPRIME_ESSENTIAL_ASSETS_URL . 'images/bars/' . $settings['bar'];
		}
		...
		<?php if ( $settings['content_source'] === 'preset' ) { ?>
			<?php include_once( SAASPRIME_ESSENTIAL_DIR_PATH . "widgets/offcanvas-preset/content-$preset_style" . '.php' ); ?>
		<?php } else { ?>
			<?php include_once( SAASPRIME_ESSENTIAL_DIR_PATH . "widgets/offcanvas-preset/content-elementor.php" ); ?>
		<?php } ?>
		<?php
	}
}