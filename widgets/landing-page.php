...
class Landing_Page extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				'wdbin_se_pg',
				[
					'label' => esc_html__( 'Main Padding', 'saasprime-essential' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'CTA Button', 'saasprime-essential' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Text Hover Color', 'saasprime-essential' ),
					'type' => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				'cta_icon_color',
				[
					'label' => esc_html__( 'Icon Color', 'saasprime-essential' ),
					'type' => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Mobile Interface', 'saasprime-essential' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__( 'General', 'saasprime-essential' ),
			]
		);
			...
			$this->add_responsive_control(
				'mobile_logo_width',
				[
					'label'              => __( 'Mobile Bar Width', 'saasprime-essential' ),
			...
			$this->add_responsive_control(
				'containersty_width',
				[
					'label'              => __( 'Main Container Width', 'saasprime-essential' ),
					'type'               => Controls_Manager::SLIDER,
					'default'            => [
						'unit' => '%',
					],
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Transparent Menu ?', 'saasprime-essential' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => '',
					'options' => [
						'' => esc_html__( 'Yes', 'saasprime-essential' ),
						'relative' => esc_html__( 'No', 'saasprime-essential' ),					
			...
			$this->add_control(
				'mobile_bar_direc',
				[
					'label' => esc_html__( 'Bar Direction', 'saasprime-essential' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => '',
					'options' => [
						'' => esc_html__( 'Default', 'saasprime-essential' ),
						'row' => esc_html__( 'Row', 'saasprime-essential' ),
						'row-reverse'  => esc_html__( 'Row Reverse', 'saasprime-essential' ),
						'column' => esc_html__( 'Column', 'saasprime-essential' ),
						'column-reverse' => esc_html__( 'Column Reverse', 'saasprime-essential' ),
			...
			$this->add_responsive_control(
				'mobile_logo_gap',
				[
					'label'              => __( 'Gap', 'saasprime-essential' ),
					'type'               => Controls_Manager::SLIDER,
					'default'            => [
						'unit' => 'px',
					],					
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Mobile Padding', 'saasprime-essential' ),
					'type' => \Elementor\Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],					
					'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Link Color', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function register_content_site_logo_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default' => 'one',
					'options' => [
						'one'   => esc_html__( 'One' , 'saasprime-essential' ),
						'two'       => esc_html__( 'Two' , 'saasprime-essential' )		
					],
		...
		$this->start_controls_section(
			'section_site_image',
			[
				'label' => __( 'Menu Settings', 'saasprime-essential' ),
			]
		);
		...
		$this->add_control(
			'custom_image',
			[
				'label'     => __( 'Logo / Image', 'saasprime-essential' ),
		...
		$this->add_group_control(
			...
			[
				'name'    => 'site_logo_size',
				'label'   => __( 'Image Size', 'saasprime-essential' ),
				'default' => 'medium',				
			]
		);
		...
		$this->add_control(
			'menu_list',
			[
				'label' => esc_html__( 'Menu List', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'list_title' => esc_html__( 'Home', 'saasprime-essential' ),						
					],					
				],
		...
		$this->start_controls_section(
			'section_logoimage',
			[
				'label' => __( 'Mobile Interface', 'saasprime-essential' ),
			]
		);
		...
		$this->start_controls_tab(
			...
			$this->add_control(
				'custom_mobile_image',
				[
					'label'     => __( 'Mobile Logo', 'saasprime-essential' ),
					'type'      => Controls_Manager::MEDIA,
					'dynamic'   => [
						'active' => true,
					],
			...
			$this->add_control(
				'custom_bar',
				[
					'label'       => __( 'Custom Mobile Bar', 'saasprime-essential' ),
			...
			$this->add_control(
				'bar',
				[
					'label' => esc_html__('Mobile Bar', 'saasprime-essential'),
			...
			$this->add_control(
				'custom_bar_image',
				[
					'label' => esc_html__( 'Choose mobile Bar Image', 'saasprime-essential' ),
		...
		$this->start_controls_section(
			'section_cta_button',
			[
				'label' => __( 'Cta Button', 'saasprime-essential' ),
				'condition' => ['preset_style' => ['two']]
			]
		);
			...
			$this->add_control(
				...
				[
					...
					'type' => \Elementor\Controls_Manager::TEXT,
					'default' => esc_html__( 'Get Started Now', 'saasprime-essential' ),
					'placeholder' => esc_html__( 'Get Started Now', 'saasprime-essential' ),
				]
			);
			...
			$this->add_control(
				'show_cta_icon',
				[
					'label' => esc_html__( 'Cta Cta Icon', 'saasprime-essential' ),
					'type' => \Elementor\Controls_Manager::SWITCHER,
					'label_on' => esc_html__( 'Show', 'saasprime-essential' ),
					'label_off' => esc_html__( 'Hide', 'saasprime-essential' ),
					'return_value' => 'yes',
		...
		$this->start_controls_section(
			'section_additional',
			[
				'label' => __( 'Additional Settings', 'saasprime-essential' ),
			]
		);
		...
		$this->add_responsive_control(
			'align',
			[
				'label'              => __( 'Alignment', 'saasprime-essential' ),
				'type'               => Controls_Manager::CHOOSE,
				'options'            => [
					'left'   => [
						'title' => __( 'Left', 'saasprime-essential' ),
						'icon'  => 'eicon-text-align-left',
					],
					'center' => [
						'title' => __( 'Center', 'saasprime-essential' ),
						'icon'  => 'eicon-text-align-center',
					],
					'right'  => [
						'title' => __( 'Right', 'saasprime-essential' ),
		...
		$this->add_control(
			'enable_url_attr',
			[
				'label' => esc_html__( 'Enable Url Attribute', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'mobile_direction',
			[
				'label' => esc_html__( 'Mobile Content Direction', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'left',
				'options' => [
	...
	protected function register_site_logo_styling_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Site logo', 'saasprime-essential' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Container Padding', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],				
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'options' => [
					'unset' => esc_html__( 'Default', 'saasprime-essential' ),
					'100/100' => esc_html__( '100/100', 'saasprime-essential' ),			
				],
				'selectors' => [
		...
		$this->add_responsive_control(
			'width',
			[
				'label'              => __( 'Width', 'saasprime-essential' ),
				'type'               => Controls_Manager::SLIDER,
				'default'            => [
					'unit' => '%',
				],
		...
		$this->add_responsive_control(
			'space',
			[
				'label'              => __( 'Max Width', 'saasprime-essential' ) . ' (%)',
				'type'               => Controls_Manager::SLIDER,
				'default'            => [
					'unit' => '%',
				],
		...
		$this->add_control(
			'logo_text_color',
			[
				'label'     => __( 'Border Color', 'saasprime-essential' ),
		...
		$this->start_controls_tab(
			'normal',
			[
				'label' => __( 'Normal', 'saasprime-essential' ),
			]
		);
			...
			$this->add_control(
				'opacity',
				[
					'label'     => __( 'Opacity', 'saasprime-essential' ),
					'type'      => Controls_Manager::SLIDER,
					'range'     => [
						'px' => [
							'max'  => 1,
		...
		$this->start_controls_tab(
			'hover',
			[
				'label' => __( 'Hover', 'saasprime-essential' ),
			]
		);
			...
			$this->add_control(
				...
				[
					'label'     => __( 'Transition Duration', 'saasprime-essential' ),
					'type'      => Controls_Manager::SLIDER,
					'range'     => [
						'px' => [
							'max'  => 3,
	...
	protected function register_site_logo_caption_styling_controls() {
		...
		$this->add_control(
			'text_color',
			[
				'label'     => __( 'Text Color', 'saasprime-essential' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			'text_active_color',
			[
				'label'     => __( 'Active Border Color', 'saasprime-essential' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [				
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Active Text & Icon Color', 'saasprime-essential' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => __( 'Typhography', 'saasprime-essential' ),
		...
		$this->add_control(
			'text_hover_color',
			[
				'label'     => __( 'Text Hover Color', 'saasprime-essential' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => __( 'Hover Typhography', 'saasprime-essential' ),
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Background Color', 'saasprime-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'caption_padding',
			[
				'label'              => __( 'Item Padding', 'saasprime-essential' ),
		...
		$this->add_responsive_control(
			'cmenu_wrap_marg',
			[
				'label'              => __( 'Menu Wrapper Margin', 'saasprime-essential' ),
				'type'               => Controls_Manager::DIMENSIONS,
				'size_units'         => [ 'px', 'em', '%' ],
				'selectors'          => [
	...
	public function site_image_url( $size ) {
		...
		if ( ! empty( $settings['custom_image']['url'] ) ) {
			...
			$logo            = saasprime_option( 'logo', $light_logo ); 				
			return $logo;
		}
	...
	protected function render() {
		...
		if(file_exists(SAASPRIME_ESSENTIAL_DIR_PATH."widgets/landing-pages/content-$preset_style".'.php')){ 
			include_once(SAASPRIME_ESSENTIAL_DIR_PATH."widgets/landing-pages/content-$preset_style".'.php'); 
		}	
	}
