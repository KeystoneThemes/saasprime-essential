...
class SaaSPrime_Button extends Widget_Base {

	public function get_name() {
		return 'wdb--saasprime-button';
	}

	public function get_title() {
		return esc_html__( 'SaaSPrime Button', 'saasprime-essential' );
	}
	...
	public function register_content_controls() {
		...
		$this->add_control(
			'btn_shape',
			[
				'label' => esc_html__( 'Choose Shape', 'saasprime-essential' ),
		...
		$this->add_control(
			'btn_width',
			[
				'label' => esc_html__( 'Button Width', 'saasprime-essential' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'prefix_class' => 'saasprime-btn-width-',
				'options' => [
					'' => esc_html__( 'Default', 'saasprime-essential' ),
					'full' => esc_html__( 'Full Width', 'saasprime-essential' ),
				],
				'condition' => [
					'btn_style' => ['3', '4'],
				],
	...
	public function register_style_controls() {
		...
		$this->add_control(
			'btn_crop_b_color_1',
			[
				'label'     => esc_html__( 'Border Color One', 'saasprime-essential' ),
		...
		$this->add_control(
			'btn_crop_b_color_2',
			[
				'label'     => esc_html__( 'Border Color Two', 'saasprime-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'btn_crop_b_color_3',
			[
				'label'     => esc_html__( 'Border Color Three', 'saasprime-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'btn_crop_b_color_4',
			[
				'label'     => esc_html__( 'Border Color Four', 'saasprime-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
