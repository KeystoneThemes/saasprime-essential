 ...
 * @since 1.0.0
 */
class SaaSPrime_Video extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'SaaSPrime Video', 'saasprime-essential' );
	}
	...
	public function get_script_depends() {
		wp_register_script( 'saasprime-video', SAASPRIME_ESSENTIAL_ASSETS_URL. '/js/widgets/video.js' , [ 'jquery' ], false, true );
		return [ 'saasprime-video' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .saasprime--video' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
