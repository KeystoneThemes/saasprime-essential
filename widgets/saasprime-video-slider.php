 ...
 * @since 1.0.0
 */
class SaaSPrime_Video_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'SaaSPrime Video Slider', 'saasprime-essential' );
	}
	...
	public function get_script_depends() {
		wp_register_script( 'saasprime-video-slider', SAASPRIME_ESSENTIAL_ASSETS_URL . '/js/widgets/video-slider.js', [ 'jquery' ], false, true );

		return [ 'swiper', 'saasprime-video-slider' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Videos', 'saasprime-essential' ),
			]
		);
		...
		$repeater->add_control(
			's_video_link',
			[
				'label' => esc_html__( 'Video Link', 'saasprime-essential' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'https://keystonethemes.com/assets/wp-content/uploads/2024/05/insurance-video.mp4', 'saasprime-essential' ),
				'placeholder' => esc_html__( 'Enter your link here', 'saasprime-essential' ),
                'label_block' => true,
			]
		);
		...
		$this->add_control(
			'video_list',
			[
				'label'   => esc_html__( 'Video Slider', 'saasprime-essential' ),
		...
		$this->add_responsive_control(
			'video_height',
			[
				'label'      => esc_html__( 'Video Height', 'saasprime-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			'active_slide_height',
			[
				'label'      => esc_html__( 'Active Height', 'saasprime-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .swiper-slide-active iframe, {{WRAPPER}} .swiper-slide-active video, {{WRAPPER}} .saasprime_video_slider' => 'height: {{SIZE}}{{UNIT}};',
				],
                'condition' => [
                        'center_slide' => 'yes',
                ],
		...
		$this->add_responsive_control(
			'active_video_height',
			[
				'label'      => esc_html__( 'Active Video Height', 'saasprime-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
	...
	private function slider_controls() {
		...
		$this->add_control(
			'center_slide',
			[
				'label'        => esc_html__( 'Center Slide', 'saasprime-essential' ),
	...
	private function slider_pagination_style_controls() {
		...
		$this->add_responsive_control(
			'dots_size',
			[
				'label'     => esc_html__( 'Dots Size', 'saasprime-essential' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 3,
		...
		$this->add_control(
			'dots_inactive_color',
			[
				'label'     => esc_html__( 'Dots Color', 'saasprime-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'dots_o_width',
			[
				'label'     => esc_html__( 'Outline width', 'saasprime-essential' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 1,
		...
		$this->add_responsive_control(
			'dots_o_offset',
			[
				'label'     => esc_html__( 'Outline Offset', 'saasprime-essential' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'min' => 1,
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'carousel-wrapper',
			[
				'class' => 'saasprime_video_slider ' . $swiper_class,
		...
		?>
        <style>
            .saasprime_vs_wrapper svg {
                width: 1em;
                height: 1em;
            }

            .saasprime_vs_wrapper video {
                min-height: 300px;
                transition: all 0.5s;
            }

            .saasprime_vs_wrapper .swiper-slide-active {
                background-color: #eee;
            }

            .saasprime_vs_wrapper .swiper-pagination-bullet-active {
                outline-offset: 5px;
                outline-width: 1px;
                outline-style: solid;
            }
