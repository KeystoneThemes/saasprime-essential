 ...
 * @since 1.0.0
 */
class SaaSPrime_Testimonial_2 extends Widget_Base {
	...
	public function get_name() {
		return 'saasprime--testimonial-2';
	}
	...
	public function get_title() {
		return esc_html__( 'SaaSPrime Testimonial 2', 'saasprime-essential' );
	}
	...
	public function get_script_depends() {
		wp_register_script( 'saasprime-testimonial-2', SAASPRIME_ESSENTIAL_ASSETS_URL . '/js/widgets/saasprime-testimonial-2.js', [ 'jquery' ], false, true );

		return [ 'swiper', 'saasprime-testimonial-2' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'client_heading',
			[
				'label' => esc_html__( 'Client', 'saasprime-essential' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	private function slider_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'both',
				'options'   => [
					'both'   => esc_html__( 'Arrows and Pagination', 'saasprime-essential' ),
					'arrows' => esc_html__( 'Arrows', 'saasprime-essential' ),
					'dots'   => esc_html__( 'Pagination', 'saasprime-essential' ),
	...
	private function slider_pagination_style_controls() {
		...
		$this->add_control(
			'bar_fill_color',
			[
				'label'     => esc_html__( 'Fill Color', 'saasprime-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render() {
		...
		?>
        <style>
        .elementor-widget-saasprime--testimonial-2 .prod_testimonial_thumb .swiper-slide {
