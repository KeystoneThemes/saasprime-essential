...
class SaaSPrime_Posts extends Widget_Base {
	...
	public function get_name() {
		return 'saasprime--posts';
	}

	public function get_title() {
		return esc_html__( 'SaaSPrime Posts', 'saasprime-essential' );
	}
	...
	public function get_style_depends() {
		...
		wp_register_style( 'saasprime-posts', SAASPRIME_ESSENTIAL_ASSETS_URL . 'css/saasprime-post.css' );

		return [ 'saasprime-button', 'saasprime-posts' ];
	}

	// Content Control
	public function register_content_controls() {
		$this->start_controls_section(
			'saasprime_sec_post_layout',
			[
				'label' => __( 'Layout', 'saasprime-essential' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'after',
				'options'   => [
					'1' => esc_html__( 'One', 'saasprime-essential' ),
					'2' => esc_html__( 'Two', 'saasprime-essential' ),
					'3' => esc_html__( 'Three', 'saasprime-essential' ),
					'4' => esc_html__( 'Four', 'saasprime-essential' ),
					'5' => esc_html__( 'Five', 'saasprime-essential' ),
				],
			]
		);
		...
		$this->add_control(
			'btn_text',
			[
				'label'       => esc_html__( 'Read More Text', 'saasprime-essential' ),
		...
		$this->add_control(
			'btn_icon',
			[
				'label'       => esc_html__( 'Read More Icon', 'saasprime-essential' ),
		...
		$this->add_control(
			'author_text',
			[
				'label'       => esc_html__( 'Date Text', 'saasprime-essential' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Written by', 'saasprime-essential' ),
				'placeholder' => esc_html__( 'Type your text here', 'saasprime-essential' ),
				'condition'   => [
					'element_list' => '2',
				],
		...
		$this->add_control(
			'link_icon',
			[
				'label'       => esc_html__( 'Link Icon', 'saasprime-essential' ),
				'type'        => Controls_Manager::ICONS,
				'skin'        => 'inline',
				'label_block' => false,
				'default'     => [
		...
		$this->add_control(
			'saasprime_show_title',
			[
				'label'     => esc_html__( 'Show Title', 'saasprime-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'saasprime-essential' ),
				'label_on'  => esc_html__( 'On', 'saasprime-essential' ),
			]
		);

		$this->add_control(
			'saasprime_show_excerpt',
			[
				'label'     => esc_html__( 'Show Excerpt', 'saasprime-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'saasprime-essential' ),
				'label_on'  => esc_html__( 'On', 'saasprime-essential' ),
		...
		$this->add_control(
			'saasprime_show_thumb',
			[
				'label'     => esc_html__( 'Show Thumbnail', 'saasprime-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'no',
				'label_off' => esc_html__( 'Off', 'saasprime-essential' ),
				'label_on'  => esc_html__( 'On', 'saasprime-essential' ),
		...
		$this->add_control(
			'saasprime_show_meta',
			[
				'label'     => esc_html__( 'Show Meta', 'saasprime-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'saasprime-essential' ),
				'label_on'  => esc_html__( 'On', 'saasprime-essential' ),
		...
		$this->add_control(
			'saasprime_show_author',
			[
				'label'     => esc_html__( 'Show Author', 'saasprime-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'saasprime-essential' ),
				'label_on'  => esc_html__( 'On', 'saasprime-essential' ),
				'condition' => [
					'saasprime_show_meta' => 'yes',
				],
			]
		);
		...
		$this->add_control(
			'saasprime_show_date',
			[
				'label'     => esc_html__( 'Show Date', 'saasprime-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'saasprime-essential' ),
				'label_on'  => esc_html__( 'On', 'saasprime-essential' ),
		...
		$this->add_control(
			'saasprime_show_category',
			[
				'label'     => esc_html__( 'Show Category', 'saasprime-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'saasprime-essential' ),
				'label_on'  => esc_html__( 'On', 'saasprime-essential' ),
		...
		$this->add_control(
			'saasprime_show_comment',
			[
				'label'     => esc_html__( 'Show Comment', 'saasprime-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'saasprime-essential' ),
				'label_on'  => esc_html__( 'On', 'saasprime-essential' ),
		...
		$this->add_control(
			'saasprime_show_rm',
			[
				'label'     => esc_html__( 'Show Read More', 'saasprime-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'saasprime-essential' ),
				'label_on'  => esc_html__( 'On', 'saasprime-essential' ),
		...
		$this->add_control(
			'saasprime_show_link',
			[
				'label'     => esc_html__( 'Show Link Icon', 'saasprime-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'label_off' => esc_html__( 'Off', 'saasprime-essential' ),
				'label_on'  => esc_html__( 'On', 'saasprime-essential' ),
		...
		// Query
		$this->start_controls_section(
			'saasprime_sec_post_query',
			[
				'label' => __( 'Query', 'saasprime-essential' ),
			]
		);
		...
		$this->add_control(
			'query_type',
			[
				'label'   => esc_html__( 'Query Type', 'saasprime-essential' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'post',
				'options' => [
					'post'    => esc_html__( 'Posts', 'saasprime-essential' ),
					'archive' => esc_html__( 'Archive', 'saasprime-essential' ),
					'related' => esc_html__( 'related', 'saasprime-essential' ),
				],
			]
		);
		...
		$this->add_control(
			'posts_id',
			[
				'label'       => esc_html__( 'Include Posts', 'saasprime-essential' ),
		...
		$this->add_control(
			'saasprime_post_order_by',
			[
				'label'     => esc_html__( 'Order By', 'saasprime-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'date',
				'options'   => [
					'date'          => esc_html__( 'Date', 'saasprime-essential' ),
					'title'         => esc_html__( 'Title', 'saasprime-essential' ),
					'menu_order'    => esc_html__( 'Menu Order', 'saasprime-essential' ),
					'modified'      => esc_html__( 'Last Modified', 'saasprime-essential' ),
					'comment_count' => esc_html__( 'Comment Count', 'saasprime-essential' ),
					'rand'          => esc_html__( 'Random', 'saasprime-essential' ),
				],
				'condition' => [
		...
		$this->add_control(
			'saasprime_post_order',
			[
				'label'     => esc_html__( 'Order', 'saasprime-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'desc',
				'options'   => [
					'asc'  => esc_html__( 'ASC', 'saasprime-essential' ),
					'desc' => esc_html__( 'DESC', 'saasprime-essential' ),
				],
				'condition' => [
					'query_type' => [ 'post', 'related' ],
				],
		...
		$this->add_control(
			'saasprime_posts_ppage',
			[
				'label'     => esc_html__( 'Posts Per Page', 'saasprime-essential' ),
	...
	public function register_style_controls() {
		...
		$this->start_controls_section(
			'saasprime_style_layout',
			[
				'label' => esc_html__( 'Layout', 'saasprime-essential' ),
		...
		$this->add_responsive_control(
			'blog_cols',
			[
				'label'     => esc_html__( 'Columns', 'saasprime-essential' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '1',
				'options'   => [
				...
				'selectors' => [
					'{{WRAPPER}} .saasprime--post' => 'grid-template-columns: repeat({{VALUE}}, 1fr);',
				],
			]
		);
		...
		$this->add_responsive_control(
			'blog_col_gap',
			[
				'label'      => esc_html__( 'Column Gap', 'saasprime-essential' ),
				...
				'selectors'  => [
					'{{WRAPPER}} .saasprime--post' => 'column-gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'blog_row_gap',
			[
				'label'      => esc_html__( 'Row Gap', 'saasprime-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .saasprime--post' => 'row-gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'blog_item_gap',
			[
				'label'      => esc_html__( 'Item Inner Gap', 'saasprime-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .saasprime--post .item' => 'gap: {{SIZE}}{{UNIT}};',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .saasprime--post .item',
                'condition' => ['element_list' => '4'],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .saasprime--post .item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'blog_h_border_color',
			[
				'label'     => esc_html__( 'Border Hover Color', 'saasprime-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .saasprime--post .item:hover' => 'border-color: {{VALUE}}',
				],
				'condition' => [
					'element_list' => '1',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
					'{{WRAPPER}} .saasprime--post .item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'sec_style_item',
			[
				'label'     => esc_html__( 'Item', 'saasprime-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'element_list' => ['3', '5'],
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .saasprime--post .wrapper' => 'width: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'element_list' =>  '5',
				],
		...
		$this->add_control(
			'item_bg_color',
			[
				'label'     => esc_html__( 'Background Color', 'saasprime-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .saasprime--post.post-style-3 .item::after, {{WRAPPER}} .saasprime--post .wrapper' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
					'{{WRAPPER}} .saasprime--post .wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
					'{{WRAPPER}} .saasprime--post .wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'sec_style_thumb',
			[
				'label'     => esc_html__( 'Thumbnail', 'saasprime-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'saasprime_show_thumb' => 'yes',
				],
			]
		);
		...
		$this->add_responsive_control(
			'bthumb_margin',
			[
				'label'      => esc_html__( 'Spacing', 'saasprime-essential' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors'  => [
		...
		// Excerpt
		$this->start_controls_section(
			'saasprime_style_excerpt',
			[
				'label'     => esc_html__( 'Excerpt', 'saasprime-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'saasprime_show_excerpt' => 'yes',
				],
			]
		);
		...
		$this->start_controls_section(
			'sec_style_meta',
			[
				'label'     => esc_html__( 'Meta', 'saasprime-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'saasprime_show_meta' => 'yes',
				],
		...
		$this->add_control(
			'separator_color',
			[
				'label'     => esc_html__( 'Separator Color', 'saasprime-essential' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'sec_style_author',
			[
				'label'     => esc_html__( 'Author', 'saasprime-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'saasprime_show_author' => 'yes',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Image', 'saasprime-essential' ),
		...
		$this->add_control(
			'author_name_heading',
			[
				'label'     => esc_html__( 'Name', 'saasprime-essential' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'element_list' => '2',
		...
		$this->start_controls_section(
			'sec_style_category',
			[
				'label'     => esc_html__( 'Category', 'saasprime-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'saasprime_show_category' => 'yes',
				],
			]
		);
		...
		$this->start_controls_section(
			'style_read_more',
			[
				'label'     => esc_html__( 'Read More', 'saasprime-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'saasprime_show_rm' => 'yes',
					'element_list'   => ['2', '4'],
				],
			]
		);
		...
		$this->start_controls_section(
			'sec_style_number',
			[
				'label'     => esc_html__( 'Number', 'saasprime-essential' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'element_list' => '1',
				],
	...
	public function register_pagination_section_controls() {
		$this->start_controls_section(
			'section_pagination',
			[
				'label' => esc_html__( 'Pagination', 'saasprime-essential' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'numbers_and_prev_next' => esc_html__( 'Numbers', 'saasprime-essential' ) . ' + ' . esc_html__( 'Previous/Next', 'saasprime-essential' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Page Limit', 'saasprime-essential' ),
				'default'   => '5',
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Shorten', 'saasprime-essential' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => '',
				'condition' => [
					'pagination_type' => 'numbers_and_prev_next',
		...
		$this->add_control(
			...
			[
				'label'            => esc_html__( 'Previous Arrow Icon', 'saasprime-essential' ),
				'type'             => Controls_Manager::ICONS,
		...
		$this->add_control(
			...
			[
				'label'            => esc_html__( 'Next Arrow Icon', 'saasprime-essential' ),
				'type'             => Controls_Manager::ICONS,
				'fa4compatibility' => 'icon',
				'skin'             => 'inline',
				'label_block'      => false,
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Colors', 'saasprime-essential' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			'pagination_spacing',
			[
				'label'      => esc_html__( 'Space Between', 'saasprime-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', 'custom' ],
				'separator'  => 'before',
				'default'    => [
	...
	protected function query_arg() {
		...
		if ( 'related' === $this->get_settings( 'query_type' ) && is_singular() ) {
			...
			$query_args['posts_per_page'] = $this->get_settings( 'saasprime_posts_ppage' );
		...
		$query_args = [
			'post_type'      => 'post',
			'posts_per_page' => $this->get_settings( 'saasprime_posts_ppage' ),
			'paged'          => $this->get_current_page(),
			'order'          => $this->get_settings( 'saasprime_post_order' ),
			'orderby'        => $this->get_settings( 'saasprime_post_order_by' ),
	...
	protected function render() {
		...
		$saasprime_query = $this->get_query();

		?>
        <div class="saasprime--post post-style-<?php echo $settings['element_list']; ?>">
			<?php
			$post_count = 1;
			while ( $saasprime_query->have_posts() ) {
				$saasprime_query->the_post();
		...
		<?php
		$this->render_pagination( $saasprime_query );
		wp_reset_postdata();
	}
	...
	protected function render_pagination( $query ) {
		...
		if ( 'numbers_and_prev_next' === $settings['pagination_type'] ) {
			$paginate_args = [
				...
				'before_page_number' => '<span class="elementor-screen-only">' . esc_html__( 'Page', 'saasprime-essential' ) . '</span>',
			];
            ...
            <nav <?php $this->print_render_attribute_string( 'pagination' ); ?>
                    aria-label="<?php esc_attr_e( 'Pagination', 'saasprime-essential' ); ?>" style="display: flex">
	...
	private function render_post_1( $settings, $post_count ) {
        ...
        <article <?php post_class( 'item' ); ?>>
			<?php
			if ( 'yes' === $settings['saasprime_show_thumb'] ) {
				?>
                <div class="thumb">
            ...
            <div class="wrapper">
                <div class="number"><?php if ( $post_count < 9 ) {
						echo esc_html__('0', 'saasprime-essential');
					}
					echo $post_count; ?></div>
                <div class="content">
					<?php
					$post_meta = [];
					$category  = saasprime_get_random_category();

					if ( 'yes' === $settings['saasprime_show_author'] ) {
					...
					if ( 'yes' === $settings['saasprime_show_category'] ) {
						$post_meta[] = $category;
					}

					if ( 'yes' === $settings['saasprime_show_date'] ) {
						$post_meta[] = get_the_date( get_option( 'date_format' ) );
					}

					if ( 'yes' === $settings['saasprime_show_comment'] ) {
						$comments_number = get_comments_number();
						$post_meta[]     = $comments_number > 1 ? sprintf( esc_html__( '%s comments', 'saasprime' ), $comments_number ) : sprintf( esc_html__( '%s comment', 'saasprime' ), $comments_number );
					}
					?>
					<?php if ( 'yes' === $settings['saasprime_show_meta'] ) { ?>
                        <div class="post-meta">
							<?php
							echo saasprime_kses( implode( '<span></span>', $post_meta ) );
							?>
                        </div>
					<?php } ?>

					<?php
					if ( 'yes' === $settings['saasprime_show_title'] ) {
						?>
                        <h2 class="title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
						<?php
					}

					if ( 'yes' === $settings['saasprime_show_excerpt'] ) {
						?>
                        <div class="cf_text">
							<?php saasprime_excerpt( 40, null ); ?>
                        </div>
						<?php
					}
					?>
				...
				<?php
				if ( 'yes' === $settings['saasprime_show_link'] ) {
					?>
                    <div class="link-wrap">
        ...
        <article <?php post_class( 'item' ); ?>>
            <div class="wrapper">
                ...
                <div class="content">
					...
					<?php
					if ( 'yes' === $settings['saasprime_show_rm'] ) {
						?>
                        <div class="wc-btn-wrapper style-<?php echo esc_html( $settings['btn_style'] ); ?>">
                            <a href="<?php the_permalink(); ?>" class="wc-btn-group">
                                ...
                                <span class="wc-btn-primary">
                                    <div class="screen-reader-text"><?php echo esc_html__('Read Post Details', 'saasprime-essential'); ?></div>
...
//		                $post_meta[] = get_the_date( get_option( 'date_format' ) );
	                ...
	                if ( 'yes' === $settings['saasprime_show_comment'] ) {
		                $comments_number = get_comments_number();
		                $post_meta[]     = $comments_number > 1 ? sprintf( "<div class='pmeta'>" . esc_html__( '%s comments', 'saasprime' ), $comments_number ) ."</div>" : sprintf( "<div class='pmeta'>" . esc_html__( '%s comment', 'saasprime' ), $comments_number ) ."</div>";
	                }
	                ?>
	                <?php if ( 'yes' === $settings['saasprime_show_meta'] ) { ?>
                        <div class="post-meta">
