...
class Banner_Breadcrumb extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Breadcrumb', 'saasprime-essential' ),				
			]
		);
		...
		$this->add_control(
			'separetor_icon',
			[
				'label' => esc_html__( 'Separetor Icon', 'saasprime-essential' ),
		...
		$this->add_control(
			'author_text',
			[
				'label'   => esc_html__( 'Author Heading', 'saasprime-essential' ),
		...
		$this->add_control(
			'error_text',
			[
				'label'   => esc_html__( '404 Heading', 'saasprime-essential' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '404 Error',	
				'placeholder' => '404',	
			]
		...
		$this->add_control(
			'search_text',
			[
				'label'   => esc_html__( 'Search Heading', 'saasprime-essential' ),
				'type'    => Controls_Manager::TEXT,
        ...
        $this->add_control(
			'show_title',
			[
				'label' => esc_html__( 'Show Heading', 'saasprime-essential' ),
		...
		$this->add_control(
			'dynamic_title',
			[
				'label' => esc_html__( 'Dynamic', 'saasprime-essential' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
        ...
        $this->add_control(
			'static_text',
			[
				'label'   => esc_html__( 'Heading Text', 'saasprime-essential' ),
				'type'    => Controls_Manager::TEXT,
		...
		$this->add_control(
			'classes',
			[
				'label'   => esc_html__( 'CSS Classes', 'saasprime-essential' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '',
				'ai'      => [
					'active' => false,
		...
		$this->add_responsive_control(
			...
			[
				...
				'options'   => [
					...
					'justify' => [
						'title' => esc_html__( 'Justified', 'saasprime-essential' ),
		...
		$this->start_controls_section(
			'section_bread_style',
			[
				'label' => __( 'Breadcrumb Style', 'saasprime-essential' ),
    		...
    		$this->add_control(
    			'link_hover_color',
    			[
    				'label'     => esc_html__( 'Link Hover Color', 'saasprime-essential' ),
    				'type'      => Controls_Manager::COLOR,
    				'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Icon Options', 'saasprime-essential' ),
            ...
            $this->add_control(
    			'title_sepe_color',
    			[
    				'label'     => esc_html__( 'Separetor Color', 'saasprime-essential' ),
    				'type'      => Controls_Manager::COLOR,
    				'selectors' => [
    		...
    		$this->add_control(
    			'sepe_icon',
    			[
    				'label' => esc_html__( 'Icon Padding', 'saasprime-essential' ),
            ...
            $this->add_control(
                'wrapper_options',
                [
                    'label' => esc_html__( 'Wrapper', 'saasprime-essential' ),
                    'type' => \Elementor\Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
            );
		...
		$this->start_controls_section(
			'section_style',
			[
				'label' => __( 'Title Style', 'saasprime-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'blend_mode',
			[
				'label'     => esc_html__( 'Blend Mode', 'saasprime-essential' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					''            => esc_html__( 'Normal', 'saasprime-essential' ),
					'multiply'    => 'Multiply',
					'screen'      => 'Screen',
					'overlay'     => 'Overlay',
					'darken'      => 'Darken',
	...
	protected function render() {
        ...
        $separete_icon = saasprime_render_elementor_icons($settings['separetor_icon']);
