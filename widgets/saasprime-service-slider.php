 ...
 * @since 1.0.0
 */
class SaaSPrime_Service_Slider extends Widget_Base {
	...
	public function get_name() {
		return 'saasprime--service-slider';
	}
	...
	public function get_title() {
		return esc_html__( 'SaaSPrime Service Slider', 'saasprime-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'saasprime--service-slider', SAASPRIME_ESSENTIAL_ASSETS_URL . 'css/service-slider.css' );

		return [ 'saasprime--service-slider' ];
	}

	public function get_script_depends() {
		wp_register_script( 'saasprime--service-slider', SAASPRIME_ESSENTIAL_ASSETS_URL . '/js/widgets/service-slider.js', [ 'jquery' ], false, true );

		return [ 'swiper', 'saasprime--service-slider' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'sec_bss_content',
			[
				'label' => esc_html__( 'Service', 'saasprime-essential' ),
			]
		);
		...
		$this->add_control(
			'bss_sec_title',
			[
				'label'       => esc_html__( 'Section Title', 'saasprime-essential' ),
		...
		$repeater->add_control(
			'bss_image',
			[
				'label'   => esc_html__( 'Choose Image', 'saasprime-essential' ),
		...
		$repeater->add_control(
			'bss_btn_link',
			[
				'label'       => esc_html__( 'Button Link', 'saasprime-essential' ),
		...
		$this->add_control(
			'bss_list',
			[
				'label'   => esc_html__( 'Services', 'saasprime-essential' ),
	...
	private function slider_controls() {
		...
		$this->add_control(
			'mousewheel',
			[
				'label'       => esc_html__( 'Mousewheel', 'saasprime-essential' ),
				'description' => esc_html__( 'If you want to use mousewheel, please disable loop.', 'saasprime-essential' ),
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'both',
				'options'   => [
					'both'   => esc_html__( 'Arrows & Fraction', 'saasprime-essential' ),
					'arrows' => esc_html__( 'Arrows', 'saasprime-essential' ),
					'dots'   => esc_html__( 'Fraction', 'saasprime-essential' ),
	...
	public function register_style_btn_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Button Icon', 'saasprime-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'btn_icon_width',
			[
				'label'     => esc_html__( 'Circle Width', 'saasprime-essential' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max' => 100,
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'carousel-wrapper',
			[
				'class' => 'saasprime_service_slider ' . $swiper_class,
