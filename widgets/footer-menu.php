...
use SaaSPrimeEssentialApp\Inc\WDB_Walker_Elementor_Footer_Nav;
...
class Footer_Menu extends Widget_Base {
    ...
    public function get_style_depends() {
        wp_register_style( 'wdb-navigation-menu', SAASPRIME_ESSENTIAL_ASSETS_URL . 'css/navigation.css' );
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'inline_menu_content',
            [
                'label' => esc_html__( 'Select Navigation & Style', 'saasprime-essential' ),
            ]
        );
            $this->add_control(
                'inline_menu_style',
                [
                    ...
                    'default' => '1',
                    'options' => [
                        '1'      => esc_html__( 'Style One', 'saasprime-essential' ),
                        '2'      => esc_html__( 'Style Two', 'saasprime-essential' ),
                        '3'      => esc_html__( 'Style Three', 'saasprime-essential' ),
                        // '4'      => esc_html__( 'Badge Menu', 'saasprime-essential' ),
                        // 'custom' => esc_html__( 'Custom Style', 'saasprime-essential' ),
                    ],
                ]
            );            
            ...
            $this->add_control(
                'menu_right_icon',
                [
                    'label' => esc_html__( 'Nav Arrow Icon', 'saasprime-essential' ),
            ...
            $this->add_control(
                'icon_left',
                [
                    'label' => esc_html__( 'Icon Left ?', 'saasprime-essential' ),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
                    'label_on' => esc_html__( 'Yes', 'saasprime-essential' ),
                    'label_off' => esc_html__( 'No', 'saasprime-essential' ),
                    'return_value' => 'yes',
            ...
            if ( ! empty( $this->get_available_menus() ) ) {
                $this->add_control(
                    ...
                    [
                        ...
                        'save_default' => true,
                        'description'  => sprintf( esc_html__( 'Go to the <a href="%s" target="_blank">Menus Option</a> to manage your menus.', 'saasprime-essential' ), admin_url( 'nav-menus.php' ) ),
                        'separator'    => 'before',
                    ]
                );
            } else {
                $this->add_control(
                    ...
                    [
                        ...
                        'raw'       => sprintf( esc_html__( '<strong>There are no menus in your site.</strong><br>Go to the <a href="%s" target="_blank">Menus Option</a> to create one.', 'saasprime-essential' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
                        'separator' => 'before',
                    ]
                );
            }
            $this->add_control(
                'menu_depth',
                [
                    'label' => esc_html__( 'Menu Depth', 'saasprime-essential' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Menu Items', 'saasprime-essential' ),
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        'block'        => esc_html__( 'Block', 'saasprime-essential' ),
                        'inline-block' => esc_html__( 'Inline Block', 'saasprime-essential' ),
                        'flex'         => esc_html__( 'Flex', 'saasprime-essential' ),
                        'inline-flex'  => esc_html__( 'Inline Flex', 'saasprime-essential' ),
                        'inherit'      => esc_html__( 'Inherit', 'saasprime-essential' ),
            ...
            $this->add_responsive_control(
                'menu_items_float',
                [
                    'label'   => esc_html__( 'Float', 'saasprime-essential' ),
                    'type'    => Controls_Manager::SELECT,
                    'default' => 'none',
                    'options' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        'justify' => [
                            'title' => esc_html__( 'Justify', 'saasprime-essential' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Single Menu Item', 'saasprime-essential' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
            // Menu Normal Tab
            $this->start_controls_tabs( 'menu_style_tabs' );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'    => esc_html__( 'Background', 'saasprime-essential' ),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'default' => 'block',
                            'options' => [
                                ''      => esc_html__( 'list-item', 'saasprime-essential' ),
                                'block'        => esc_html__( 'Block', 'saasprime-essential' ),
                                'inline-block' => esc_html__( 'Inline Block', 'saasprime-essential' ),
                                'flex'         => esc_html__( 'Flex', 'saasprime-essential' ),
                                'inline-flex'  => esc_html__( 'Inline Flex', 'saasprime-essential' ),
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            'label'   => esc_html__( 'List Style', 'saasprime-essential' ),
                            'type'    => Controls_Manager::SELECT,
                            'default' => 'none',
                            'condition' => [
                                'menu_display' => ['']
                            ...
                            'options' => [
                                'none'                 => esc_html__('None','saasprime-essential'),
                                'disc'                 => esc_html__('Disc','saasprime-essential'),
                                'circle'               => esc_html__('Circle','saasprime-essential'),
                                'square'               => esc_html__('Square','saasprime-essential'),
                                'decimal'              => esc_html__('Decimal','saasprime-essential'),
                                'decimal-leading-zero' => esc_html__('Decimal-leading-zero','saasprime-essential'),
                                'bengali'          => esc_html__('bengali','saasprime-essential'),
                                'lower-roman'          => esc_html__('Lower Roman','saasprime-essential'),
                                'upper-roman'          => esc_html__('Upper Roman','saasprime-essential'),
                                'lower-greek'          => esc_html__('Lower Greek','saasprime-essential'),
                                'lower-latin'          => esc_html__('Lower Latin','saasprime-essential'),
                                'upper-latin'          => esc_html__('Upper Latin','saasprime-essential'),
                                'armenian'             => esc_html__('Armenian','saasprime-essential'),
                                'georgian'             => esc_html__('Georgian','saasprime-essential'),
                                'lower-alpha'          => esc_html__('Lower Alpha','saasprime-essential'),
                                'upper-alpha'          => esc_html__('Upper Alpha','saasprime-essential'),
                            ],
                            'selectors' => [                                
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'options' => [
                                'initial'  => esc_html__( 'Initial', 'saasprime-essential' ),
                                'relative' => esc_html__( 'Relative', 'saasprime-essential' ),
                                'static'   => esc_html__( 'Static', 'saasprime-essential' ),
                            ],
                            'selectors' => [
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'     => esc_html__( 'Border', 'saasprime-essential' ),
                            'selector'  => '{{WRAPPER}} .single__menu__nav .wdb__menu li a',
                            'separator' => 'before',
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label'     => esc_html__( 'Box Shadow', 'saasprime-essential' ),
                            'selector'  => '{{WRAPPER}} .single__menu__nav .wdb__menu li a',
                            'separator' => 'before',
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    [
                        'label' => esc_html__( 'Active', 'saasprime-essential' ),
                    ]
                );
        ...
        $this->start_controls_section(
            'badge_style_section',
            [
                'label'     => esc_html__( 'Badge', 'saasprime-essential' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_menu_bedge' => 'yes',
                ]
